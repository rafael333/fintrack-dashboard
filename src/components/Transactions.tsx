...
const Transactions = () => {
  ...
  return (
    <div className="bg-white p-3 lg:p-6 rounded-lg shadow border">
        ...
        <div className="flex flex-row items-center justify-between gap-1 lg:gap-3 mb-3 lg:mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="hidden lg:flex items-center space-x-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-sm font-medium transition-all duration-200 hover:scale-105"
            >
                    ...
                    <tr key={transaction.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                      ...
                      <td className="py-3 lg:py-4 px-1 lg:px-4 text-center">
                        <div className="flex flex-col items-center space-y-0 lg:space-y-2">
                          <button
                            onClick={() => handleOpenPaymentModal(transaction)}
                            className={`inline-flex px-1 lg:px-2 py-0.5 lg:py-1 text-[8px] lg:text-xs font-medium rounded-full transition-colors ${
                              transaction.paidInstallments === transaction.totalInstallments
                                ? 'bg-green-500 text-white hover:bg-green-600 intense-pulse-green ring-2 ring-green-300'
                                : transaction.paidInstallments > 0
                                ? 'bg-yellow-500 text-white hover:bg-yellow-600 intense-pulse-yellow ring-2 ring-yellow-300'
                                : 'bg-red-500 text-white hover:bg-red-600 intense-pulse ring-2 ring-red-300'
                            }`}
                          >
                            {transaction.paidInstallments === transaction.totalInstallments
                              ? 'Pago'
                  ...
                  <tr key={transaction.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    ...
                    <td className="py-3 lg:py-4 px-1 lg:px-4 text-center">
                      <div className="flex flex-col items-center space-y-0 lg:space-y-2">
                        <button
                          onClick={() => handleOpenPaymentModal(transaction)}
                          className={`inline-flex px-1 lg:px-3 py-0.5 lg:py-1 text-[8px] lg:text-xs font-medium rounded-full transition-colors ${
                            transaction.isPaid
                              ? 'bg-green-500 text-white hover:bg-green-600 intense-pulse-green ring-2 ring-green-300'
                              : 'bg-red-500 text-white hover:bg-red-600 intense-pulse ring-2 ring-red-300'
                          }`}
      ...
      <button 
        onClick={handleModalOpen}
        className="lg:hidden fixed bottom-6 right-6 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white w-16 h-16 rounded-full shadow-xl flex items-center justify-center transition-all duration-300 hover:scale-110 active:scale-95 z-50 group"
        style={{
                          ...
                          <label key={installment.id} className="flex items-center space-x-2 cursor-pointer">
                            ...
                            <div className="flex-1">
                              ...
                              <span className={`ml-2 text-xs px-2 py-1 rounded-full ${
                                installment.isPaid 
                                  ? 'bg-green-500 text-white intense-pulse-green ring-2 ring-green-300' 
                                  : 'bg-red-500 text-white intense-pulse ring-2 ring-red-300'
                              }`}>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-4 lg:p-6 border-t border-gray-200 space-y-2 sm:space-y-0 sm:space-x-3">
              ...
              <button 
                onClick={() => setIsFiltersModalOpen(false)}
                className="flex items-center justify-center space-x-2 px-6 py-2 text-xs lg:text-sm font-medium text-white bg-blue-600 border border-blue-600 rounded-lg hover:bg-blue-700 hover:border-blue-700 transition-colors shadow-md"
              >
                <span>✅</span>
                <span>Aplicar</span>
              </button>
