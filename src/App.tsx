          ...
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
              <div className="bg-white p-4 lg:p-6 rounded-lg shadow border">
                ...
                <p className="text-sm lg:text-base text-gray-600">Lista de atividades recentes será exibida aqui.</p>
              </div>
              <InstallmentAccounts />
            </div>
          </>
      ...
      <div className="min-h-screen bg-gray-50 overflow-x-hidden">
        <div className="flex max-w-full">
          ...
          <div className="flex-1 lg:ml-0 ml-0 min-w-0 overflow-x-hidden">
            <main className="px-0 lg:px-6 py-4 lg:py-6 space-y-4 lg:space-y-6 pb-20 lg:pb-6 max-w-full overflow-x-hidden">
              {renderContent()}
            </main>
          </div>
        </div>
